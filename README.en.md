...
The project's client API request definitions are located at `web/src/services/api-schema.ts`. They are automatically generated from the server's [OpenAPI file](http://0.0.0.0:8000/openapi.json) using [openapi-typescript](https://openapi-ts.dev/).
